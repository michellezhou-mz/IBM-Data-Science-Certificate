...
display_cover(top = 'Python', bottom = 'Data Science')
...
x= raw_title.replace('<title>', '')
band_title = x.replace('- Wikipedia', '')
print (band_title)
...
print (start, end)
raw_album_name = page[94:125]
print (raw_album_name)
x = raw_album_name.replace('<title>','')
album_title = x.replace('- Wikipedia','')
print (album_title)
...
img_1 = display_cover(top = album_title, bottom = band_title)
